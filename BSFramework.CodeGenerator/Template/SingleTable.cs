using BSFramework.CodeGenerator.Comm;
using BSFramework.CodeGenerator.Model;
...
namespace BSFramework.CodeGenerator.Template 
{
    /// <summary>
    /// 描 述：代码生成模板（单表）
    /// </summary>
    ...
    {
        private string AssTag = Assembly.GetExecutingAssembly().ManifestModule.Name.Substring(0, Assembly.GetExecutingAssembly().ManifestModule.Name.IndexOf("."));
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("using {0}.Entity." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.AppendFormat("namespace {0}.Mapping." + baseConfigModel.OutputAreas + "\r\n", AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("using {0}.Entity." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.AppendFormat("using {0}.IService." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.Append("using BSFramework.Data.Repository;\r\n");
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.AppendFormat("namespace {0}.Service." + baseConfigModel.OutputAreas + "\r\n", AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        /// <param name=\"queryJson\">查询参数</param>\r\n");
                sb.Append("        /// <returns>返回分页列表</returns>\r\n");
                sb.Append("        public DataTable GetPageListByProc(Pagination pagination, string queryJson)\r\n");
                sb.Append("        {\r\n");
                sb.Append("            DatabaseType dataType = DbHelper.DbType;\r\n");
                sb.Append("            var queryParam = queryJson.ToJObject();\r\n");
                sb.Append("            //if (!queryParam[\"Name\"].IsEmpty())\r\n");
                sb.Append("             //{\r\n");
                sb.Append("               //string name = queryParam[\"Name\"].ToString().Trim();\r\n");
                sb.Append("               //pagination.conditionJson += string.Format(\" and name like '{0}%'\", name);\r\n");
                sb.Append("             //}\r\n");
                sb.Append("            return this.BaseRepository().FindTableByProcPager(pagination,dataType);\r\n");
                sb.Append("        }\r\n");
            }
            sb.Append("        /// <summary>\r\n");
            sb.Append("        /// 获取列表\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendFormat("namespace {0}.IService." + baseConfigModel.OutputAreas + "\r\n", AssTag);
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        /// <param name=\"queryJson\">查询参数</param>\r\n");
                sb.Append("        /// <returns>返回分页列表</returns>\r\n");
                sb.Append("        DataTable GetPageListByProc(Pagination pagination, string queryJson);\r\n");
            }
            sb.Append("        /// <summary>\r\n");
            sb.Append("        /// 获取列表\r\n");
            sb.Append("        /// </summary>\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendFormat("using {0}.Entity." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.AppendFormat("using {0}.IService." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.AppendFormat("using {0}.Service." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        public DataTable GetPageListByProc(Pagination pagination, string queryJson)\r\n");
                sb.Append("        {\r\n");
                sb.Append("            return service.GetPageListByProc(pagination,queryJson);\r\n");
                sb.Append("        }\r\n");
            }
            sb.Append("        /// <summary>\r\n");
            sb.Append("        /// 获取列表\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("using {0}.Entity." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.AppendFormat("using {0}.Busines." + baseConfigModel.OutputAreas + ";\r\n", AssTag);
            sb.Append("using BSFramework.Util;\r\n");
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        {\r\n");
                sb.Append("            var watch = CommonHelper.TimerStart();\r\n");
                sb.Append("            pagination.p_kid = \""+baseConfigModel.DataBaseTablePK+"\";\r\n");
                sb.Append("            pagination.p_fields =\"*\";//注：此处要替换成需要查询的列\r\n");
                sb.Append("            pagination.p_tablename =\""+baseConfigModel.DataBaseTableName+"\";\r\n");
                sb.Append("            pagination.conditionJson = \"1=1\";\r\n");

                sb.Append("            var data = " + baseConfigModel.BusinesClassName.ToLower() + ".GetPageListByProc(pagination, queryJson);\r\n");
                sb.Append("            var jsonData = new\r\n");
                sb.Append("            {\r\n");
                sb.Append("                rows = data,\r\n");
                sb.Append("                total = pagination.total,\r\n");
