...
namespace BSFramework.CodeGenerator.Template
{
    ...
    public class MultiTable
    {
        ...
        {
            string databaseLinkID = multiTableConfigModel.DataBaseLinkId;
            ...
            try
            {
                ...
                sb.Append("using BSFramework.Application.Code;\r\n");
                sb.Append("using System.ComponentModel.DataAnnotations.Schema;\r\n");
                sb.Append("using System.ComponentModel.DataAnnotations;\r\n\r\n");


                sb.Append("namespace BSFramework.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                ...
                {
                    sb.Append("    [Table(\"" + multiTableConfigModel.DataBaseTableName.ToUpper() + "\")]\r\n");
                }
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using BSFramework.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace BSFramework.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
                sb.Append("    /// </summary>\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using BSFramework.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace BSFramework.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace BSFramework.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using BSFramework.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace BSFramework.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using BSFramework.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using BSFramework.Util;\r\n");
            sb.Append("using BSFramework.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace BSFramework.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
