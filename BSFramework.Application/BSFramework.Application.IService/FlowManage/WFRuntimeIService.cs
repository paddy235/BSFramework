...
namespace BSFramework.Application.IService.FlowManage
{
    ...
    public interface WFRuntimeIService
    {
        ...
        /// <returns></returns>
        bool CreateInstance(string userid, string username, Guid processId, string schemeInfoId, WFProcessInstanceEntity wfProcessInstanceEntity, string frmData = null);
        /// <summary>
        /// 创建一个实例(草稿创建)
        /// </summary>
        ...
        /// <returns></returns>
        bool CreateInstance(string userid, string username, WFProcessInstanceEntity wfProcessInstanceEntity, string frmData = null);
        /// <summary>
        /// 编辑表单再次提交(驳回后处理)
        /// </summary>
        /// <param name="processId"></param>
        ...
        /// <param name="frmData"></param>
        /// <returns></returns>
        bool EditionInstance(string username, string processId, string description, string frmData = null);
        /// <summary>
        /// 创建一个草稿
        /// </summary>
        /// <param name="processId"></param>
        ...
        /// <param name="processId"></param>
        /// <returns></returns>
        bool NodeVerification(string userid, string username, string processId, bool flag, string description = "");
        /// <summary>
        /// 驳回
        /// </summary>
        /// <param name="processId"></param>
        ...
        /// <param name="description"></param>
        /// <returns></returns>
        bool NodeReject(string userid, string username, string processId, string nodeId, string description = "");
        /// <summary>
        /// 召回流程进程
        /// </summary>
        /// <param name="processId"></param>
        void CallingBackProcess(string username, string processId);
        /// <summary>
        /// 终止一个实例(彻底删除)
        /// </summary>
        /// <param name="processId"></param>
