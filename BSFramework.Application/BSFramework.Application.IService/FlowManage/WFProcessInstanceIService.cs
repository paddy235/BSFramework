...
namespace BSFramework.Application.IService.FlowManage
{
    ...
    public interface WFProcessInstanceIService
    {
        ...
        /// <returns></returns>
        DataTable GetPageList(string userid, Pagination pagination, string queryJson, string type);
         /// <summary>
        /// 获取登录者需要处理的流程
        /// </summary>
        /// <param name="pagination"></param>
        /// <param name="queryJson"></param>
        /// <returns></returns>
        DataTable GetToMeBeforePageList(string userid, Pagination pagination, string queryJson);
         /// <summary>
        /// 获取登录者已经处理的流程
        /// </summary>
        /// <param name="pagination"></param>
        /// <param name="queryJson"></param>
        /// <returns></returns>
        DataTable GetToMeAfterPageList(string userid, Pagination pagination, string queryJson);
        /// <summary>
        /// 获取实例进程信息实体
        /// </summary>
        ...
        /// <returns></returns>
        int OperateVirtualProcess(string username, string keyValue, int state);
                /// <summary>
        /// 流程指派
        /// </summary>
