...
namespace BSFramework.Application.Service.BaseManage
{
    ...
    public class ModuleService : RepositoryFactory<ModuleEntity>, IModuleService
    {
        ...
        {
            var entity = this.BaseRepository().IQueryable(t => t.EnCode == enCode).FirstOrDefault();
            return entity;
        }
        /// <summary>
        /// 根据菜单的名称获取菜单的信息
        ...
        {
            System.Linq.Expressions.Expression<Func<ModuleEntity, bool>> expression = x => x.FullName.Contains(moduleName);
