...
{
    public class EduBookService : RepositoryFactory<EduBookEntity>, IEduBookService
    {
        public IEnumerable<EduBookEntity> GetList(string deptid, string eduid)
        {
        ...
        public IEnumerable<EduBookEntity> GetPageList(string deptid, int page, int pagesize, out int total)
        {
            //string deptid = OperatorProvider.Provider.Current().DeptId;
        ...
        public EduBookEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, EduBookEntity entity)
        {
