...
namespace BSFramework.Application.Busines.PerformanceManage
{
    ...
    /// 绩效管理数据
    /// </summary>
    public class PerformanceSecondBLL
    {

        private IPerformanceSecondService service = new PerformanceSecondService();
        private IPerformancesetupSecondService Setupservice = new PerformancesetupSecondService();
        ...
        /// <returns></returns>
        public List<PerformanceSecondEntity> getScore(DateTime time, string departmentid)
        {
        ...
        /// 获取绩效数据
        /// </summary>
        public object getScoreList(DateTime time, string departmentid)
        {
            //所有数据
        ...
        /// 获取个人绩效数据
        /// </summary>
        public object getScore(string userid, DateTime time, string departmentid)
        {
            //所有数据
            var message = string.Empty;
            try
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    if (num != -1)
                    {
                        ...
                        List<PerformanceSecondEntity> entity = new List<PerformanceSecondEntity>();
                        entity.Add(user);
                        service.operation(entity);
                    }
        ...
        public List<PerformanceSecondEntity> getScore(DateTime usetime, List<string> departIds)
        {
