...
using BSFramework.Application.Busines.WeChatManage;
...
namespace BSFramework.Application.Web.Areas.WeChatManage.Controllers
{
    /// <summary>
    /// 描 述：企业号成员
    /// </summary>
    public class UserController : MvcControllerBase
    {
        ...
        [AjaxOnly]
        [HandlerAuthorize(PermissionMode.Enforce)]
        [HandlerMonitor(0, "(App)一键同步企业号成员")]
