...
namespace BSFramework.Application.Web.Areas.AuthorizeManage.Controllers
{
    ...
    public class PermissionUserController : MvcControllerBase
    {
        ...
        [AjaxOnly]
        [HandlerMonitor(5, "保存(新增或修改)用户授权信息")]
        ...
        {
            permissionBLL.SaveAuthorize((int)AuthorizeTypeEnum.User, userId, moduleIds, moduleButtonIds, moduleColumnIds, authorizeDataJson);
            return Success("保存成功。");
        }
        #endregion
    }
