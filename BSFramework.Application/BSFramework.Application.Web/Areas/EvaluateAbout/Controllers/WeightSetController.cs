...
namespace BSFramework.Application.Web.Areas.EvaluateAbout.Controllers
{
    ...
    /// 班组权重设置
    /// </summary>
    public class WeightSetController : MvcControllerBase
    {
        private WeightSetBLL safetydaybll = new WeightSetBLL();
        ...
        {
            pagination.p_kid = "Id";
            pagination.p_fields = "ClassName,createdate,IsFiring,Weight";
            pagination.p_tablename = "wg_WeightSet";
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, WeightSetEntity entity)
        {
