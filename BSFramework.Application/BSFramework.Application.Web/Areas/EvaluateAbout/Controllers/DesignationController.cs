...
namespace BSFramework.Application.Web.Areas.EvaluateAbout.Controllers
{
    ...
    /// 班组称号管理
    /// </summary>
    public class DesignationController : MvcControllerBase
    {
        private DesignationBLL safetydaybll = new DesignationBLL();
        ...
        {
            pagination.p_kid = "Id";
            pagination.p_fields = "ClassName,createdate,IsFiring,SortCode,Remark";
            pagination.p_tablename = "wg_Designation";
