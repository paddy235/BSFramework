...
namespace BSFramework.Application.Web.Areas.CustomerManage.Controllers
{
    ...
    public class OrderController : MvcControllerBase
    {
        ...
        public void ExportOrderEntry(string orderId)
        {
            ...
            list.Add(new TemplateMode() { row = 17, cell = 11, value = cachedata.First(x => x.EnCode == "Client_PaymentMode" && x.ItemValue == order.PaymentMode).ItemName });
