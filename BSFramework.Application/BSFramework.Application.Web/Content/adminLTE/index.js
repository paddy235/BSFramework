                ...
                if (row.ParentId == "0") {
                    ...
                    if (row.UrlAddress != null && row.UrlAddress != undefined) {
                        if (row.UrlAddress.length > 2) {
                            _html += '<a class="menuItem" data-id="' + row.ModuleId + '" href="' + contentPath + row.UrlAddress + '">'
                        }
                        else {
                            _html += '<a href="#">'
                        }
                        ...
                        $.each(childNodes, function (i) {
                            ...
                            if (subchildNodes.length > 0) {
                                ...
                                $.each(subchildNodes, function (i) {
                                    ...
                                    _html += '<li><a class="menuItem" data-id="' + subchildNodesrow.ModuleId + '" href="' + contentPath + subchildNodesrow.UrlAddress + '"><i class="' + subchildNodesrow.Icon + '"></i>' + subchildNodesrow.FullName + '</a></li>';
                                });
                                _html += '</ul>';

                            } else {
                                _html += '<a class="menuItem" data-id="' + subrow.ModuleId + '" href="' + contentPath + subrow.UrlAddress + '"><i class="' + subrow.Icon + '"></i>' + subrow.FullName + '</a>';
                            }
                            _html += '</li>';
                        });
                        _html += '</ul>';
