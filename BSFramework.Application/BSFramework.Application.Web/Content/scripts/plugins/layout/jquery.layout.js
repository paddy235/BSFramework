...
function setBar(obj) {
    ...
    if (left == "-270px") {
        ...
        $(".ui-layout-center").css({ left: $(".ui-layout-west").width()+5, width: $(window).width() - $(".ui-layout-west").width() });
        $("#gridTable").setGridWidth($(window).width() - $(".ui-layout-west").width(), true);
    } else {
        $(obj).attr("class", "fa fa-arrow-right");
        $(".ui-layout-west").css({ left: "-270px" });
        $(".ui-layout-center").css({ left: "36px", width: $(window).width() - 36 });
