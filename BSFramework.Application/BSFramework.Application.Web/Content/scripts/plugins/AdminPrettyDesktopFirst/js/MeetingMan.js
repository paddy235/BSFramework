...
jQuery(function () {
    ...
    uploader = WebUploader.create({
        ...
        disableGlobalDnd: true,
        chunked: false,
        server: '../../../Utility/PostFileActity?recId=' + $("#EndBaseId").val() + "&filePath=Safetyday&ptype=2&isDate=1",
        fileNumLimit: 5,
        fileSizeLimit: 500 * 1024 * 1024,
        fileSingleSizeLimit: 100 * 1024 * 1024
    });
    ...
    function addFile(file) {
        ...
        var $li = $('<div class="row" style="margin:10px;"><div class="col-sm-6">' + file.name + '</div><div class="col-sm-2"><a href="../../../ResourceFile/DownloadFile?keyValue=-1&filename=' + encodeURI(file.name) + '&recId=' + $("#EndBaseId").val() + '\" target="_blank" style="cursor:pointer"  title="下载文件"><i class="fa fa-download"></i></a>&nbsp;&nbsp;&nbsp;<a style="cursor:pointer" onclick="removeFile(\'' + file.name + '\',\'' + $("#EndBaseId").val() + '\',this)"><i class="fa fa-trash-o"></i></a></div></div>' +
                '<p class="imgWrap"></p>' +
                '<p class="progress" style="display:none;"><span></span></p>'),
...
jQuery(function () {
    ...
    uploader = WebUploader.create({
        ...
        disableGlobalDnd: true,
        chunked: false,
        server: '../../../Utility/PostFileActity?recId=' + $("#EndBaseId").val() + "&filePath=Safetyday&ptype=3&isDate=1",
        fileNumLimit: 5,
        fileSizeLimit: 500 * 1024 * 1024,
        fileSingleSizeLimit: 100 * 1024 * 1024
    });
