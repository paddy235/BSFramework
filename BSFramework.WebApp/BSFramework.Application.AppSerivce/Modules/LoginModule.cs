        ...
        private Negotiator CheckLogin(dynamic _)
        {
            ...
            try
            {
                ...
                if (userEntity != null)
                {
                    ...
                    result.organizename = new OrganizeBLL().GetEntity(result.organizeid).FullName;//organizeCache.GetEntity(result.organizeid).FullName;
                    result.departmentid = userEntity.DepartmentId;
                    result.departmentname = new DepartmentBLL().GetEntity(userEntity.DepartmentId).FullName;
                    result.roleid = userEntity.RoleId;
                    result.rolename = new RoleBLL().GetEntity(userEntity.RoleId).FullName;
