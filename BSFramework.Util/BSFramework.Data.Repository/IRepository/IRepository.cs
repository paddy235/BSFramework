...
namespace BSFramework.Data.Repository
{
    ...
    public interface IRepository
    {
        ...
        //扩展方法
        //IEnumerable<T> FindListByProcPager<T>(string p_kid, string p_fields, string p_tablename, string p_strwhere,
        //string p_ordercolumn, string p_orderstyle, float p_curpage, float p_pagesize, out float p_totalrecords, out float p_totalpages, DatabaseType dataType) where T : class;
        ...
        DataTable FindTableByProcPager(Pagination pagination, DatabaseType dataType);
    }
}
