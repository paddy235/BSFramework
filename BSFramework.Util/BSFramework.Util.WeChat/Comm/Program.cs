...
using BSFramework.Util.WeChat.Model;
using BSFramework.Util.WeChat.Model.Request;
using BSFramework.Util.WeChat.Model.Request.SendMessage;
using BSFramework.Util;
using BSFramework.Util.WeChat.Helper;

namespace BSFramework.Util.WeChat
{
    class Program
    {
