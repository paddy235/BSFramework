    ...
    public class DbHelper
    {
        ...
        public object ExecuteScalar(CommandType cmdType, string cmdText, params DbParameter[] parameters)
        {
            try
            {
                ...
                Params = DbParameters.ToDbParameter(parameters);
                PrepareCommand(dbConnection, dbCommand, null, cmdType, cmdText, Params);
        ...
        private void PrepareCommand(DbConnection conn, IDbCommand cmd, DbTransaction isOpenTrans, CommandType cmdType, string cmdText, params DbParameter[] dbParameter)
        {
            ...
            cmd.CommandText = dbParameter == null || dbParameter.Length==0?cmdText:DbParameters.FormatSql(cmdText);
            if (isOpenTrans != null)
        ...
        /// <param name="dbParameter">Sql参数</param>
        /// <returns></returns>
        public IDataReader ExecuteReader(CommandType cmdType, string strSql, bool isAddParam, params DbParameter[] dbParameter)
        {
            try
            {
