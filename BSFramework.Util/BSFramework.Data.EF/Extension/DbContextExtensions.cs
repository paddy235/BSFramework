...
namespace BSFramework.Data.EF.Extension
{
    /// <summary>
    /// 描 述：EF上下文 扩展方法
    /// </summary>
    public static class DbContextExtensions
    {
        ...
        {
            StringBuilder strSql = new StringBuilder(string.Format("delete from " + tableName + " where " + propertyName + " in ('{0}')", propertyValue.ToString().Replace(",","','")));
            return strSql.ToString();
        }
        /// <summary>
        /// 拼接批量删除SQL语句
        ...
        {
            StringBuilder strSql = new StringBuilder(string.Format("delete from " + tableName + " where " + propertyName + " IN ('{0}')",string.Join("','",propertyValue)));
            return strSql.ToString();
        }
        /// <summary>
        /// 获取实体映射对象
