...
{
    public class EducationYJService: BaseService
    {
        public EducationYJService(string messagekey, string businessId)
        ...
        public override string GetContent()
        {
            ...
            if (entity.EduType == "5" || entity.EduType == "6" || entity.EduType == "7") 
            {
                content = string.Format("您有今日截止未完成作答的题目：{0}，请您及时处理", entity.Theme);
            }
            return content;
        }
