...
{
    public class WorkPlanService : BaseService
    {
        public WorkPlanService(string messagekey, string businessId) : base(messagekey, businessId)
        { }
        ...
        public override string GetMessage()
        {
            ...
            this.Config.Template = this.Config.Template.Replace("{date}", plan.StartDate.ToString("yyyy-M-d") + " - " + plan.EndDate.ToString("yyyy-M-d"));
